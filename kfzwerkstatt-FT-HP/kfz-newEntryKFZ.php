...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tblFahrzeuge (KundenNr, Kennzeichen, Marke, Typ, Baujahr, kmStand, kw, Treibstoff, Tueren, karosieform, Zulassung, Erstzulassung, Fahrgestellnummer, Motornummer, Hubraum, FIN) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("issisiiissssssi",$kundenNr, $kennzeichen, $marke, $typ, $baujahr, $kmStand, $kw, $treibstoff, $tueren, $karosieform, $zulassung, $erstzulassung, $fahrgestellnummer, $motornummer, $hubraum, $fin);
